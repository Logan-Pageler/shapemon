...
public class Caught {
	public static boolean caught(int oppLvl, int itemLvl) {
		...
		if (1 <= opp && opp <= 20) {
			...
			switch (item) {
				case 1:
					chance = 44 - (0.05 * (opp - 21) * (opp - 21) + (0.05 * (opp - 21))) / 10;
					break;
				case 2:
					chance = 54 - (0.05 * (opp - 21) * (opp - 21) + (0.05 * (opp - 21))) / 10;
					break;
				case 3:
					chance = 64 - (0.05 * (opp - 21) * (opp - 21) + (0.05 * (opp - 21))) / 10;
					break;
				case 4:
					chance = 74 - (0.05 * (opp - 21) * (opp - 21) + (0.05 * (opp - 21))) / 10;
					break;
			}
			c = chance;
			...
			switch (item) {
				case 1:
					chance = 7 - (((opp - 61) * (opp - 61)) / 250.0);
					break;
				case 2:
					chance = 17 - (((opp - 61) * (opp - 61)) / 150.0);
					break;
				case 3:
