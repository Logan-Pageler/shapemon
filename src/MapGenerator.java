...
public class MapGenerator extends JPanel {
	...
	Shapemon oldShape = null;
	Shapemon newShape = null;
	private int wu = 1;
	private int ws = 1;

	Path currentPath = Paths.get(System.getProperty("user.dir"));
	private Image check = (new ImageIcon(Paths.get(currentPath.toString(), "assets",  "check.gif").toString()).getImage());
	private Image check2 = (new ImageIcon(Paths.get(currentPath.toString(), "assets",  "check2.gif").toString()).getImage());
	private Image select1 = (new ImageIcon(Paths.get(currentPath.toString(), "assets",  "select1.gif").toString()).getImage());
	private Image select1pt2 = (new ImageIcon(Paths.get(currentPath.toString(), "assets",  "select1pt2.gif").toString()).getImage());
	private Image select7 = (new ImageIcon(Paths.get(currentPath.toString(), "assets",  "select7.gif").toString()).getImage());
	private Image select7pt2 = (new ImageIcon(Paths.get(currentPath.toString(), "assets",  "select7pt2.gif").toString()).getImage());
	private Image storage1 = (new ImageIcon(Paths.get(currentPath.toString(), "assets",  "storage1.gif").toString()).getImage());
	private Image storage2 = (new ImageIcon(Paths.get(currentPath.toString(), "assets",  "storage2.gif").toString()).getImage());
	private Image leftArrow = (new ImageIcon(Paths.get(currentPath.toString(), "assets",  "left.gif").toString()).getImage());
	private Image rightArrow = (new ImageIcon(Paths.get(currentPath.toString(), "assets",  "right.gif").toString()).getImage());
	private Image left2 = (new ImageIcon(Paths.get(currentPath.toString(), "assets",  "left2.gif").toString()).getImage());
	private Image right2 = (new ImageIcon(Paths.get(currentPath.toString(), "assets",  "right2.gif").toString()).getImage());
	...
	private Image star = (new ImageIcon(Paths.get(currentPath.toString(), "assets",  "StarAnim.gif").toString()).getImage());
	...
	private Image blank = (new ImageIcon(Paths.get(currentPath.toString(), "assets",  "blank.gif").toString()).getImage());
	...
	private String playerSprite = Paths.get(currentPath.toString(), "assets","PlayerUpStill.gif").toString();

	private int XShift = 0;
	private int YShift = 0;

	private Image grassTile = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "GrassTile.gif").toString()).getImage();
	private Image proffesor = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "Proffesor.gif").toString()).getImage();
	private Image house1Tile1 = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "House1Tile1.gif").toString()).getImage();
	private Image house1Tile2 = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "House1Tile2.gif").toString()).getImage();
	private Image house1Tile3 = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "House1Tile3.gif").toString()).getImage();
	private Image house1Tile4 = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "House1Tile4.gif").toString()).getImage();
	private Image house1Tile5 = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "House1Tile5.gif").toString()).getImage();
	private Image house1Tile6 = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "House1Tile6.gif").toString()).getImage();
	private Image house1Tile7 = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "House1Tile7.gif").toString()).getImage();
	private Image house1Tile8 = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "House1Tile8.gif").toString()).getImage();
	private Image house1Tile9 = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "House1Tile9.gif").toString()).getImage();
	private Image house1Tile10 = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "House1Tile10.gif").toString()).getImage();
	private Image house1Tile11 = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "House1Tile11.gif").toString()).getImage();
	private Image house1Tile12 = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "House1Tile12gif").toString()).getImage();
	private Image house1Tile13 = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "House1Tile13.gif").toString()).getImage();
	private Image house1Tile14 = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "House1Tile14.gif").toString()).getImage();
	private Image house1Tile15 = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "House1Tile15.gif").toString()).getImage();
	private Image house1Tile16 = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "House1Tile16.gif").toString()).getImage();
	private Image lightSand = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "LightSand.gif").toString()).getImage();
	private Image pathBottom = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "PathBottom.gif").toString()).getImage();
	private Image pathBottomLeft1 = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "PathBottomLeft1.gif").toString()).getImage();
	private Image pathBottomLeft2 = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "PathBottomLeft2.gif").toString()).getImage();
	private Image pathBottomRight1 = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "PathBottomRight1.gif").toString()).getImage();
	private Image pathBottomRight2 = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "PathBottomRight2.gif").toString()).getImage();
	private Image pathCenter = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "PathCenter.gif").toString()).getImage();

	private Image shapemonTitle = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "ShapemonTitle.gif").toString()).getImage();

	private boolean playSwimmingAnimation = false;
	private int swimmingAnimationPart = 1;

	private Image treeTopRight = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "TreeTopRight.gif").toString()).getImage();
	private Image treeTopLeft = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "TreeTopLeft.gif").toString()).getImage();
	private Image treeMiddleRight = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "TreeMiddleRight.gif").toString()).getImage();
	private Image treeMiddleLeft = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "TreeMiddleLeft.gif").toString()).getImage();
	private Image treeBottomRight = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "TreeBottomRight.gif").toString()).getImage();
	private Image treeBottomLeft = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "TreeBottomLeft.gif").toString()).getImage();
	private Image tallGrass = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "TallGrass.gif").toString()).getImage();
	private Image rockTile = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "RockTile.gif").toString()).getImage();
	private Image waterTile = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "WaterTile.gif").toString()).getImage();
	private Image waterTile1 = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "WaterTile1.gif").toString()).getImage();
	private Image waterTile2 = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "WaterTile2.gif").toString()).getImage();
	private Image waterGroundMurgeGroundUp1 = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "WaterGroundMurgeGroundUp1.gif").toString()).getImage();
	private Image waterGroundMurgeGroundUp2 = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "WaterGroundMurgeGroundUp2.gif").toString()).getImage();
	private Image waterGroundMurgeGroundLeft1 = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "WaterGroundMurgeGroundLeft1.gif").toString()).getImage();
	private Image waterGroundMurgeGroundLeft2 = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "WaterGroundMurgeGroundleft2.gif").toString()).getImage();
	private Image waterGroundMurgeGroundDown1 = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "WaterGroundMurgeGroundDown1.gif").toString()).getImage();
	private Image waterGroundMurgeGroundDown2 = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "WaterGroundMurgeGroundDown2.gif").toString()).getImage();
	private Image waterGroundMurgeGroundRight1 = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "WaterGroundMurgeGroundRight1.gif").toString()).getImage();
	private Image waterGroundMurgeGroundRight2 = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "WaterGroundMurgeGroundRight2.gif").toString()).getImage();
	private Image waterGroundMurgeWaterUpLeft1 = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "WaterGroundMurgeWaterUpLeft1.gif").toString()).getImage();
	private Image waterGroundMurgeWaterUpLeft2 = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "WaterGroundMurgeWaterUpLeft2.gif").toString()).getImage();
	private Image waterGroundMurgeWaterUpRight1 = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "WaterGroundMurgeWaterUpRight1.gif").toString()).getImage();
	private Image waterGroundMurgeWaterUpRight2 = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "WaterGroundMurgeWaterUpRight2.gif").toString()).getImage();
	private Image waterGroundMurgeWaterDownLeft1 = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "WaterGroundMurgeWaterDownLeft1.gif").toString()).getImage();
	private Image waterGroundMurgeWaterDownLeft2 = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "WaterGroundMurgeWaterDownLeft2.gif").toString()).getImage();
	private Image waterGroundMurgeWaterDownRight1 = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "WaterGroundMurgeWaterDownRight1.gif").toString()).getImage();
	private Image waterGroundMurgeWaterDownRight2 = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "WaterGroundMurgeWaterDownRight2.gif").toString()).getImage();
	private Image waterGroundMurgeGroundUpLeft1 = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "WaterGroundMurgeGroundUpLeft1.gif").toString()).getImage();
	private Image waterGroundMurgeGroundUpLeft2 = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "WaterGroundMurgeGroundUpLeft2.gif").toString()).getImage();
	private Image waterGroundMurgeGroundUpRight1 = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "WaterGroundMurgeGroundUpRight1.gif").toString()).getImage();
	private Image waterGroundMurgeGroundUpRight2 = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "WaterGroundMurgeGroundUpRight2.gif").toString()).getImage();
	private Image waterGroundMurgeGroundDownLeft1 = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "WaterGroundMurgeGroundDownLeft1.gif").toString()).getImage();
	private Image waterGroundMurgeGroundDownLeft2 = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "WaterGroundMurgeGroundDownLeft2.gif").toString()).getImage();
	private Image waterGroundMurgeGroundDownRight1 = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "WaterGroundMurgeGroundDownRight1.gif").toString())
			.getImage();
	private Image waterGroundMurgeGroundDownRight2 = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "WaterGroundMurgeGroundDownRight2.gif").toString())
			.getImage();

	private Image hillTileFront = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "HillTileFront.gif").toString()).getImage();
	private Image hillTileLeft = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "HillTileLeft.gif").toString()).getImage();
	private Image hillTileRight = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "HillTileRight.gif").toString()).getImage();
	private Image hillTileTop = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "HillTileTop.gif").toString()).getImage();
	private Image hillTileGroundDownLeft = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "HillTileGroundDownLeft.gif").toString()).getImage();
	private Image hillTileGroundDownRight = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "HillTileGroundDownRight.gif").toString()).getImage();
	private Image hillTileGroundUpLeft = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "HillTileGroundUpLeft.gif").toString()).getImage();
	private Image hillTileGroundUpRight = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "HillTileGroundUpRight.gif").toString()).getImage();
	private Image hillTileHillDownLeft = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "HillTileHillDownLeft.gif").toString()).getImage();
	private Image hillTileHillDownRight = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "HillTileHillDownRight.gif").toString()).getImage();
	private Image hillTileHillUpLeft = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "HillTileHillUpLeft.gif").toString()).getImage();
	private Image hillTileHillUpRight = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "HillTileHillUpRight.gif").toString()).getImage();

	private Image waterMurgeUp = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "WaterMurgeUp.gif").toString()).getImage();
	private Image waterMurgeLeft = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "WaterMurgeLeft.gif").toString()).getImage();
	private Image waterMurgeDown = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "WaterMurgeDown.gif").toString()).getImage();
	private Image waterMurgeRight = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "WaterMurgeRight.gif").toString()).getImage();
	private Image waterMurgeSandUpLeft = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "WaterMurgeSandUpLeft.gif").toString()).getImage();
	private Image waterMurgeSandUpRight = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "WaterMurgeSandUpRight.gif").toString()).getImage();
	private Image waterMurgeSandDownLeft = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "WaterMurgeSandDownLeft.gif").toString()).getImage();
	private Image waterMurgeSandDownRight = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "WaterMurgeSandDownRight.gif").toString()).getImage();
	private Image waterMurgeWaterUpLeft = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "WaterMurgeWaterUpLeft.gif").toString()).getImage();
	private Image waterMurgeWaterUpRight = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "WaterMurgeWaterUpRight.gif").toString()).getImage();
	private Image waterMurgeWaterDownLeft = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "WaterMurgeWaterDownLeft.gif").toString()).getImage();
	private Image waterMurgeWaterDownRight = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "WaterMurgeWaterDownRight.gif").toString()).getImage();

	private Image lightSandCorner1 = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "LightSandCorner1.gif").toString()).getImage();
	private Image lightSandCorner2 = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "LightSandCorner2.gif").toString()).getImage();
	private Image lightSandCorner3 = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "LightSandCorner3.gif").toString()).getImage();
	private Image lightSandCorner4 = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "LightSandCorner4.gif").toString()).getImage();

	private Image shapemonCenter = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "ShapemonCenter.gif").toString()).getImage();
	private Image shapemonCenterInside = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "ShapemonCenterInside.gif").toString()).getImage();
	private Image house2 = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "house2.gif").toString()).getImage();
	private Image house3 = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "house3.gif").toString()).getImage();
	private Image house4 = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "house4.gif").toString()).getImage();
	private Image house5 = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "house5.gif").toString()).getImage();
	private Image breakableRock = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "breakableRock.gif").toString()).getImage();
	private Image breakableTree = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "breakableTree.gif").toString()).getImage();

	private Image stairRightTop = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "StairRightTop.gif").toString()).getImage();
	private Image stairRightBottom = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "StairRightBottom.gif").toString()).getImage();
	private Image stairRightTop2 = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "StairRightTop2.gif").toString()).getImage();
	private Image stairRightBottom2 = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "StairRightBottom2.gif").toString()).getImage();
	private Image stairRightCenter = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "StairRightCenter.gif").toString()).getImage();
	private Image stairForwardRight = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "StairForwardRight.gif").toString()).getImage();
	private Image stairForwardCenter = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "StairForwardCenter.gif").toString()).getImage();
	private Image stairForwardLeft = new ImageIcon(Paths.get(currentPath.toString(), "assets",  "StairForwardLeft.gif").toString()).getImage();
	private Battle battle;
	private Player player;
	SaveFile saveFile = new SaveFile(Paths.get(currentPath.toString(), "ShapemonSaveFile.txt").toString());
	int shapeNew, shapeOld;

	public MapGenerator(int[] mapP1, int[] mapP2, int[] mapP3, int[] mapP4, int[] mapP5, Player player,
			Battle battle) {
		this.battle = battle;
		n = mapP1;
		n2 = mapP2;
		...
		if (menuOpen) {
			...
			if (menuPart == 0) {
				if (frame < 300) {
					...
					// start up animation
					if (frame < 60) {
						int starX = (int) (Math.cos((12 * (frame - 1) + 90) * Math.PI / 180)
								* (360 - 6 * frame) + 360);
						int starY = (int) (360
								- Math.sin((12 * (frame - 1) + 90) * Math.PI / 180)
										* (360 - 6 * frame - 1));
						g.setColor(Color.RED);
						drawStar(starX, starY, 50, g);
					}
					if (frame >= 60 && frame < 90) {
						g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "Logo1.gif").toString())).getImage(), 0, 0, 720, 720,
								null);
					}
					if (frame >= 90 && frame < 135) {
						g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "Logo2.gif").toString())).getImage(), 0, 0, 720, 720,
								null);
					}
					if (frame >= 135 && frame < 180) {
						g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "Logo3.gif").toString())).getImage(), 0, 0, 720, 720,
								null);
					...
					if (frame >= 180) {
						g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "Logo4.gif").toString())).getImage(), 0, 0, 720, 720,
								null);
						g.setColor(Color.WHITE);
						g.fillRect(117, 414, 5, 6);
						g.fillRect(144, 414, 5, 6);
					...
					if (frame >= 60 && frame < 180) {
						...
						drawStar((int) (360 - 13.31479 * (frame % 30)),
								(int) (360 - 4.32623 * (frame % 30)), 30, g);
						drawStar((int) (360 + 13.31479 * (frame % 30)),
								(int) (360 - 4.32623 * (frame % 30)), 30, g);
						drawStar((int) (360 - 8.228993 * (frame % 30)),
								(int) (360 + 11.3262 * (frame % 30)), 30, g);
						drawStar((int) (360 + 8.228993 * (frame % 30)),
								(int) (360 + 11.3262 * (frame % 30)), 30, g);
				...
				if (selected == 1) {
					...
					if (select) {
						...
						resetXY();
						SwitchShape.storage = new Shapemon[96];
				...
				menuPart = SwitchShape.computerScreen(g, player, battle, this, menuPart, upPressed,
						downPressed, rightPressed, leftPressed, enterPressed);
	...
	public void standStill() {
		if (!swimming) {
			if (movingDirection == 0) {
				playerSprite = Paths.get(currentPath.toString(), "assets","PlayerUpStill.gif").toString();
			} else if (movingDirection == 1) {
				playerSprite = Paths.get(currentPath.toString(), "assets", "PlayerLeftStill.gif").toString();
			} else if (movingDirection == 2) {
				playerSprite = Paths.get(currentPath.toString(), "assets","PlayerDownStill.gif").toString();
			} else if (movingDirection == 3) {
				playerSprite = Paths.get(currentPath.toString(), "assets","PlayerRightStill.gif").toString();
			}
		} else {
			if (movingDirection == 0) {
				playerSprite = Paths.get(currentPath.toString(), "assets","PlayerWaterUp.gif").toString();
			} else if (movingDirection == 1) {
				playerSprite = Paths.get(currentPath.toString(), "assets","PlayerWaterLeft.gif").toString();
			} else if (movingDirection == 2) {
				playerSprite = Paths.get(currentPath.toString(), "assets","PlayerWaterDown.gif").toString();
			} else if (movingDirection == 3) {
				playerSprite = Paths.get(currentPath.toString(), "assets","PlayerWaterRight.gif").toString();
			}
		}
	}
	...
	public void moveUp(int f) {
		...
		if (!swimming) {
			if (f % 16 == 0) {
				playerSprite = Paths.get(currentPath.toString(), "assets","PlayerUpStep1.gif").toString();
			} else if (f % 8 == 0) {
				playerSprite = Paths.get(currentPath.toString(), "assets","PlayerUpStep2.gif").toString();
			}
		} else {
			playerSprite = Paths.get(currentPath.toString(), "assets","PlayerWaterUp.gif").toString();
		}
	...
	public void moveRight(int f) {
		...
		if (!swimming) {
			if (f % 16 == 0) {
				playerSprite = Paths.get(currentPath.toString(), "assets","PlayerRightStep1.gif").toString();
			} else if (f % 8 == 0) {
				playerSprite = Paths.get(currentPath.toString(), "assets","PlayerRightStep2.gif").toString();
			}
		} else {
			playerSprite = Paths.get(currentPath.toString(), "assets","PlayerWaterRight.gif").toString();
		}
	...
	public void moveDown(int f) {
		...
		if (!swimming) {
			if (f % 16 == 0) {
				playerSprite = Paths.get(currentPath.toString(), "assets","PlayerDownStep1.gif").toString();
			} else if (f % 8 == 0) {
				playerSprite = Paths.get(currentPath.toString(), "assets","PlayerDownStep2.gif").toString();
			}
		} else {
			playerSprite = Paths.get(currentPath.toString(), "assets","PlayerWaterDown.gif").toString();
		}
	...
	public void moveLeft(int f) {
		...
		if (!swimming) {
			if (f % 16 == 0) {
				playerSprite = Paths.get(currentPath.toString(), "assets","PlayerLeftStep1.gif").toString();
			} else if (f % 8 == 0) {
				playerSprite = Paths.get(currentPath.toString(), "assets","PlayerLeftStep2.gif").toString();
			}
		} else {
			playerSprite = Paths.get(currentPath.toString(), "assets","PlayerWaterLeft.gif").toString();
		}
	...
	private void save() {
		...
		saveFile.setSave(x + "," + y + "," + movingDirection + "," + swimming + ","
				+ MainClass.getTutorialPart() + "," + shapemonCenterNumber + "," +
				player.toSave() + "," + SwitchShape.getSaveData());
	}

	// load data
	private void load() {
		List<String> save = saveFile.getSave();

		if (save == null) {
			return;
		}

		String[] data = saveFile.getSave().get(3).split(",");

		x = Integer.parseInt(data[0]);

		y = Integer.parseInt(data[1]);

		movingDirection = Integer.parseInt(data[2]);
		swimming = Boolean.parseBoolean(data[3]);

		x = x / 64 * 64 + -56;
		y = y / 64 * 64 + -56;

		MainClass.setTutorialPart(Integer.parseInt(data[4]));
		shapemonCenterNumber = Integer.parseInt(data[5]);

		player.loadFromSave(data[6]);

		SwitchShape.loadSaveData(data[7]);
	...
	// rest of code is long simple algorith of breaking down arrays into printable
	// tiles
				...
				try {
					if (k < n.length) {
						if (n[k] == 0) {
							...
							g.drawImage(pathCenter, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);

						} else if (n[k] == 30) {

							g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "PathLeft.gif").toString())).getImage(),
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);

						} else if (n[k] == 31) {

							g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "PathRight.gif").toString())).getImage(),
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);

						} else if (n[k] == 32) {

							g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "PathTop.gif").toString())).getImage(),
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);

						} else if (n[k] == 33) {

							g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "PathBottom.gif").toString())).getImage(),
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);

						} else if (n[k] == 34) {

							g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "PathBottomLeft1.gif").toString())).getImage(),
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);

						} else if (n[k] == 35) {

							g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "PathBottomRight1.gif").toString())).getImage(),
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);

						} else if (n[k] == 36) {

							g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "PathTopLeft1.gif").toString())).getImage(),
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);

						} else if (n[k] == 37) {

							g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "PathTopRight1.gif").toString())).getImage(),
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);

						} else if (n[k] == 38) {

							g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "PathBottomLeft2.gif").toString())).getImage(),
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);

						} else if (n[k] == 39) {

							g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "PathBottomRight2.gif").toString())).getImage(),
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);

						} else if (n[k] == 40) {

							g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "PathTopLeft2.gif").toString())).getImage(),
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);

						} else if (n[k] == 41) {

							g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "PathTopRight2.gif").toString())).getImage(),
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);

						} else if (n[k] == 50) {

							g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "WaterLeft.gif").toString())).getImage(),
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);

						} else if (n[k] == 51) {

							g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "WaterRight.gif").toString())).getImage(),
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);

						} else if (n[k] == 52) {

							g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "WaterTop.gif").toString())).getImage(),
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);

						} else if (n[k] == 53) {

							g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "WaterBottom.gif").toString())).getImage(),
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(tallGrass, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(treeTopLeft, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(treeTopRight, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(treeMiddleLeft, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(treeMiddleRight, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(treeBottomLeft, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(treeBottomRight, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(rockTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(treeTopLeft, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							// water
							g.drawImage(waterTile1, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);

						} else if (n[k] == 4) {
							// wet sand
							g.drawImage(waterTile2, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);

						} else if (n[k] == 5) {
							// rock on dry sand
							g.drawImage(waterTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);

						} else if (n[k] == 6) {
							// rock on wet sand
							g.setColor(new Color(200, 170, 0));
							g.fillRect(64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64);
							g.setColor(new Color(155, 100, 50));
							g.fillRect(64 * (j - 1) + x + 10, 64 * (i - 1) + y + 10, 60,
									60);
						} else if (n[k] == 7) {
							// dirt tile
							...
							g.drawImage(waterMurgeDown, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(rockTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage(lightSand, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(rockTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage(waterMurgeRight, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(rockTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage(waterGroundMurgeGroundDown1,
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(rockTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage(waterGroundMurgeGroundUp1,
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(rockTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage(waterMurgeWaterDownLeft,
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);

						} else if (n[k] == 72) {

							g.drawImage(waterMurgeWaterUpLeft, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);

						} else if (n[k] == 73) {

							g.drawImage(waterMurgeWaterUpRight, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);

						} else if (n[k] == 74) {

							g.drawImage(waterMurgeWaterDownRight,
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage(waterMurgeUp, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage(waterMurgeLeft, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);

						} else if (n[k] == 79) {

							g.drawImage(waterMurgeSandUpLeft, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);

						} else if (n[k] == 64) {

							g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "SandMurgeLightUpRight.gif").toString()))
									.getImage(), 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);

						} else if (n[k] == 81) {

							g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "SandMurgeLightDownLeft.gif").toString()))
									.getImage(), 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);

						} else if (n[k] == 82) {

							g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "SandMurgeLightDownRight.gif").toString()))
									.getImage(), 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);

						} else if (n[k] == 83) {

							g.drawImage(waterMurgeSandDownRight,
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "RedFlower.gif").toString())).getImage(),
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);

						} else if (n[k] == 121) {

							g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "GrassTile.gif").toString())).getImage(),
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "House1Tile1.gif").toString())).getImage(),
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "GrassTile.gif").toString())).getImage(),
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "House1Tile2.gif").toString())).getImage(),
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "GrassTile.gif").toString())).getImage(),
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "House1Tile3.gif").toString())).getImage(),
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "GrassTile.gif").toString())).getImage(),
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "House1Tile4.gif").toString())).getImage(),
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "GrassTile.gif").toString())).getImage(),
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "House1Tile5.gif").toString())).getImage(),
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "GrassTile.gif").toString())).getImage(),
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "House1Tile6.gif").toString())).getImage(),
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "GrassTile.gif").toString())).getImage(),
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "House1Tile7.gif").toString())).getImage(),
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "GrassTile.gif").toString())).getImage(),
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "House1Tile8.gif").toString())).getImage(),
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "GrassTile.gif").toString())).getImage(),
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "House1Tile9.gif").toString())).getImage(),
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "GrassTile.gif").toString())).getImage(),
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "House1Tile10.gif").toString())).getImage(),
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "GrassTile.gif").toString())).getImage(),
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "House1Tile11.gif").toString())).getImage(),
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "GrassTile.gif").toString())).getImage(),
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "House1Tile12.gif").toString())).getImage(),
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "GrassTile.gif").toString())).getImage(),
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "House1Tile13.gif").toString())).getImage(),
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "GrassTile.gif").toString())).getImage(),
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "House1Tile14.gif").toString())).getImage(),
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "GrassTile.gif").toString())).getImage(),
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "House1Tile15.gif").toString())).getImage(),
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "GrassTile.gif").toString())).getImage(),
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "House1Tile16.gif").toString())).getImage(),
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "GrassTile.gif").toString())).getImage(),
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "TreeTopLeft3.gif").toString())).getImage(),
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(waterGroundMurgeGroundUp2,
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(waterGroundMurgeGroundLeft1,
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(waterGroundMurgeGroundLeft2,
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(waterGroundMurgeGroundDown2,
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(waterGroundMurgeGroundRight1,
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(waterGroundMurgeGroundRight2,
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(waterGroundMurgeGroundUpRight1,
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(waterGroundMurgeGroundUpRight2,
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(waterGroundMurgeGroundUpLeft1,
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(waterGroundMurgeGroundUpLeft2,
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(waterGroundMurgeGroundDownRight1,
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(waterGroundMurgeGroundDownRight2,
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(waterGroundMurgeGroundDownLeft1,
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(waterGroundMurgeGroundDownLeft2,
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(waterGroundMurgeWaterUpRight1,
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(waterGroundMurgeWaterUpRight2,
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(waterGroundMurgeWaterUpLeft1,
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(waterGroundMurgeWaterUpLeft2,
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(waterGroundMurgeWaterDownRight1,
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(waterGroundMurgeWaterDownRight2,
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(waterGroundMurgeWaterDownLeft1,
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(waterGroundMurgeWaterDownLeft2,
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(hillTileFront, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(hillTileLeft, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(hillTileTop, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(hillTileRight, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(hillTileHillUpLeft, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(hillTileHillUpRight, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(hillTileHillDownLeft, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(hillTileHillDownRight, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(hillTileGroundUpLeft, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(hillTileGroundUpRight, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(hillTileGroundDownLeft, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(hillTileGroundDownRight,
									64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(lightSandCorner4, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 88 + YShift, 32, 32, null);
							g.drawImage(lightSandCorner3, 64 * (j - 1) - 88 + XShift,
									64 * (i - 1) - 88 + YShift, 32, 32, null);
							g.drawImage(hillTileFront, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(lightSandCorner2, 64 * (j - 1) - 88 + XShift,
									64 * (i - 1) - 120 + YShift, 32, 32, null);
							g.drawImage(lightSandCorner4, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 88 + YShift, 32, 32, null);
							g.drawImage(lightSandCorner3, 64 * (j - 1) - 88 + XShift,
									64 * (i - 1) - 88 + YShift, 32, 32, null);
							...
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift + 64,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift + 128,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift + 192,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift + 256,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift + 320,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift + 384,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift + 468,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift + 512,
									64 * (i - 1) - 120 + YShift, 64, 64, null);

							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift + 64, 64, 64, null);
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift + 512,
									64 * (i - 1) - 120 + YShift + 64, 64, 64, null);
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift + 128, 64, 64,
									null);
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift + 512,
									64 * (i - 1) - 120 + YShift + 128, 64, 64,
									null);
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift + 192, 64, 64,
									null);
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift + 512,
									64 * (i - 1) - 120 + YShift + 192, 64, 64,
									null);
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift + 256, 64, 64,
									null);
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift + 512,
									64 * (i - 1) - 120 + YShift + 256, 64, 64,
									null);
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift + 320, 64, 64,
									null);
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift + 512,
									64 * (i - 1) - 120 + YShift + 320, 64, 64,
									null);
							...
							g.drawImage(shapemonCenter, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 576, 448, null);
						} else if (n[k] == 997) {
							...
							g.drawImage(shapemonCenter, 64 * (j - 1) - 120 + XShift - 512,
									64 * (i - 1) - 120 + YShift, 576, 448, null);
						} else if (n[k] == 996) {
							...
							g.drawImage(house2, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 256, 256, null);
						} else if (n[k] == 993) {
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift - 64,
							...
							g.drawImage(house2, 64 * (j - 1) - 120 + XShift - 192,
									64 * (i - 1) - 120 + YShift, 256, 256, null);
						} else if (n[k] == 992) {
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage(house3, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 256, 256, null);
						} else if (n[k] == 989) {
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage(house3, 64 * (j - 1) - 120 + XShift - 192,
									64 * (i - 1) - 120 + YShift, 256, 256, null);
						} else if (n[k] == 988) {
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage(house4, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 256, 256, null);
						} else if (n[k] == 985) {
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage(house4, 64 * (j - 1) - 120 + XShift - 192,
									64 * (i - 1) - 120 + YShift, 256, 256, null);
						} else if (n[k] == 984) {
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage(house5, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 256, 256, null);
						} else if (n[k] == 981) {
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage(house5, 64 * (j - 1) - 120 + XShift - 192,
									64 * (i - 1) - 120 + YShift, 256, 256, null);
						} else if (n[k] == 980) {
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(breakableTree, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
						} else if (n[k] == 977) {
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(breakableRock, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
						} else if (n[k] == 400) {
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							...
							g.setColor(Color.black);
							g.fillRect(64 * (j - 1) - 120 + XShift - 448,
									64 * (i - 1) - 120 + YShift - 256, 960, 64);
							g.fillRect(64 * (j - 1) - 120 + XShift - 448,
									64 * (i - 1) - 120 + YShift + 256, 960, 64);
							g.fillRect(64 * (j - 1) - 120 + XShift - 448,
									64 * (i - 1) - 120 + YShift - 192, 64, 448);
							g.fillRect(64 * (j - 1) - 120 + XShift + 448,
									64 * (i - 1) - 120 + YShift + 192, 64, 448);
							g.drawImage(shapemonCenterInside,
									64 * (j - 1) - 120 + XShift - 448,
									64 * (i - 1) - 120 + YShift - 256, 960, 576,
									null);
							...
							g.drawImage(pathCenter, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(proffesor, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift - 16, 64, 80, null);
						} else if (n[k] == 402) {
							g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift,
									64 * (i - 1) - 120 + YShift, 64, 64, null);
							g.drawImage(tallGrass, 64 * (j - 1) - 120 + XShift,
					...
					} else if (k > n.length + n2.length + n3.length - 1
							&& k - n.length - n2.length - n3.length < n4.length) {
						drawArray4(g, k, i, j);
					} else if (k > n.length + n2.length + n3.length + n4.length - 1 && k - n.length
							- n2.length - n3.length - n4.length < n5.length) {
						drawArray5(g, k, i, j);
					}
				} catch (Exception e) {
	...
	private void drawArray2(Graphics g, int k, int i, int j) {
		if (n2[k - n.length] == 0) {
			...
			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "LightSand.gif").toString())).getImage(),
					64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);

		} else if (n2[k - n.length] == 71) {

			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "SandMurgeDarkDownLeft.gif").toString()))
					.getImage(), 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);

		} else if (n2[k - n.length] == 72) {

			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "SandMurgeDarkUpLeft.gif").toString()))
					.getImage(), 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);

		} else if (n2[k - n.length] == 73) {

			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "SandMurgeDarkUpRight.gif").toString()))
					.getImage(), 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);

		} else if (n2[k - n.length] == 74) {

			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "SandMurgeDarkDownRight.gif").toString()))
					.getImage(), 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);

		} else if (n2[k - n.length] == 75) {

			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "SandMurgeDown.gif").toString())).getImage(),
					64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);

		} else if (n2[k - n.length] == 76) {

			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "SandMurgeUp.gif").toString())).getImage(),
					64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);

		} else if (n2[k - n.length] == 77) {

			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "SandMurgeRight.gif").toString())).getImage(),
					64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);

		} else if (n2[k - n.length] == 78) {

			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "SandMurgeLeft.gif").toString())).getImage(),
					64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);

		} else if (n2[k - n.length] == 79) {

			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "SandMurgeLightUpLeft.gif").toString()))
					.getImage(), 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);
			...
			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "WaterMurgeSandDownRight.gif").toString()))
					.getImage(), 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);

		} else if (n2[k - n.length] == 87) {

			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "WaterMurgeWaterUpLeft.gif").toString()))
					.getImage(), 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);

		} else if (n2[k - n.length] == 95) {
		...
		} else if (n2[k - n.length] == 98) {

			g.drawImage(waterTile1,
					64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage(rockTile, 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);
			...
			g.drawImage(stairForwardLeft, 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);

		} else if (n2[k - n.length] == 501) {
			g.drawImage(stairForwardCenter, 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);

		} else if (n2[k - n.length] == 502) {
			g.drawImage(stairForwardRight, 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);
	...
	private void drawArray3(Graphics g, int k, int i, int j) {
		if (n3[k - n.length - n2.length] == 0) {
			...
			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "PathLeft.gif").toString())).getImage(), 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);

		} else if (n3[k - n.length - n2.length] == 31) {

			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "PathRight.gif").toString())).getImage(), 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);

		} else if (n3[k - n.length - n2.length] == 32) {

			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "PathTop.gif").toString())).getImage(), 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);

		} else if (n3[k - n.length - n2.length] == 33) {

			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "PathBottom.gif").toString())).getImage(), 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);

		} else if (n3[k - n.length - n2.length] == 34) {

			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "PathBottomLeft1.gif").toString())).getImage(), 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);

		} else if (n3[k - n.length - n2.length] == 35) {

			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "PathBottomRight1.gif").toString())).getImage(), 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);

		} else if (n3[k - n.length - n2.length] == 36) {

			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "PathTopLeft1.gif").toString())).getImage(), 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);

		} else if (n3[k - n.length - n2.length] == 37) {

			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "PathTopRight1.gif").toString())).getImage(), 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);

		} else if (n3[k - n.length - n2.length] == 38) {

			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "PathBottomLeft2.gif").toString())).getImage(), 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);

		} else if (n3[k - n.length - n2.length] == 39) {

			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "PathBottomRight2.gif").toString())).getImage(), 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);

		} else if (n3[k - n.length - n2.length] == 40) {

			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "PathTopLeft2.gif").toString())).getImage(), 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);

		} else if (n3[k - n.length - n2.length] == 41) {

			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "PathTopRight2.gif").toString())).getImage(), 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);

		} else if (n3[k - n.length - n2.length] == 50) {

			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "WaterLeft.gif").toString())).getImage(), 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);

		} else if (n3[k - n.length - n2.length] == 51) {

			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "WaterRight.gif").toString())).getImage(), 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);

		} else if (n3[k - n.length - n2.length] == 52) {

			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "WaterTop.gif").toString())).getImage(), 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);

		} else if (n3[k - n.length - n2.length] == 53) {

			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "WaterBottom.gif").toString())).getImage(), 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);
			...
			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage(treeTopLeft, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64,
					null);

		} else if (n3[k - n.length - n2.length] == 12) {

			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage(treeTopRight, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64,
					null);

		} else if (n3[k - n.length - n2.length] == 13) {

			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage(treeMiddleLeft, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64,
					null);

		} else if (n3[k - n.length - n2.length] == 14) {

			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage(treeMiddleRight, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64,
					null);

		} else if (n3[k - n.length - n2.length] == 15) {

			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage(treeBottomLeft, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64,
					null);

		} else if (n3[k - n.length - n2.length] == 16) {

			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage(treeBottomRight, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64,
					null);
			...
			g.drawImage(waterMurgeDown, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64,
					null);
			g.drawImage(rockTile, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64, null);
			...
			g.drawImage(waterMurgeRight, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64,
					null);
			g.drawImage(rockTile, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64, null);
			...
			g.drawImage(waterMurgeWaterDownLeft, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift,
					64, 64, null);

		} else if (n3[k - n.length - n2.length] == 72) {

			g.drawImage(waterMurgeWaterUpLeft, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64,
					64, null);

		} else if (n3[k - n.length - n2.length] == 73) {

			g.drawImage(waterMurgeWaterUpRight, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift,
					64, 64, null);

		} else if (n3[k - n.length - n2.length] == 74) {

			g.drawImage(waterMurgeWaterDownRight, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift,
					64, 64, null);
			...
			g.drawImage(waterMurgeUp, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64,
					null);
			...
			g.drawImage(waterMurgeLeft, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64,
					null);

		} else if (n3[k - n.length - n2.length] == 79) {

			g.drawImage(waterMurgeSandUpLeft, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64,
					64, null);

		} else if (n3[k - n.length - n2.length] == 64) {

			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "SandMurgeLightUpRight.gif").toString())).getImage(),
					64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64, null);

		} else if (n3[k - n.length - n2.length] == 81) {

			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "SandMurgeLightDownLeft.gif").toString())).getImage(),
					64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64, null);

		} else if (n3[k - n.length - n2.length] == 82) {

			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "SandMurgeLightDownRight.gif").toString())).getImage(),
					64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64, null);

		} else if (n3[k - n.length - n2.length] == 83) {

			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "WaterMurgeSandDownRight.gif").toString())).getImage(),
					64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64, null);

		} else if (n3[k - n.length - n2.length] == 87) {

			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "WaterMurgeWaterUpLeft.gif").toString())).getImage(),
					64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64, null);

		} else if (n3[k - n.length - n2.length] == 99) {

			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "RedFlower.gif").toString())).getImage(), 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);

		} else if (n3[k - n.length - n2.length] == 121) {

			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "GrassTile.gif").toString())).getImage(), 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "House1Tile1.gif").toString())).getImage(), 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);
			...
			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "GrassTile.gif").toString())).getImage(), 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "House1Tile2.gif").toString())).getImage(), 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);
			...
			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "GrassTile.gif").toString())).getImage(), 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "House1Tile3.gif").toString())).getImage(), 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);
			...
			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "GrassTile.gif").toString())).getImage(), 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "House1Tile4.gif").toString())).getImage(), 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);
			...
			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "GrassTile.gif").toString())).getImage(), 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "House1Tile5.gif").toString())).getImage(), 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);
			...
			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "GrassTile.gif").toString())).getImage(), 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "House1Tile6.gif").toString())).getImage(), 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);
			...
			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "GrassTile.gif").toString())).getImage(), 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "House1Tile7.gif").toString())).getImage(), 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);
			...
			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "GrassTile.gif").toString())).getImage(), 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "House1Tile8.gif").toString())).getImage(), 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);
			...
			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "GrassTile.gif").toString())).getImage(), 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "House1Tile9.gif").toString())).getImage(), 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);
			...
			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "GrassTile.gif").toString())).getImage(), 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "House1Tile10.gif").toString())).getImage(), 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);
			...
			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "GrassTile.gif").toString())).getImage(), 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "House1Tile11.gif").toString())).getImage(), 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);
			...
			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "GrassTile.gif").toString())).getImage(), 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "House1Tile12.gif").toString())).getImage(), 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);
			...
			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "GrassTile.gif").toString())).getImage(), 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "House1Tile13.gif").toString())).getImage(), 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);
			...
			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "GrassTile.gif").toString())).getImage(), 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "House1Tile14.gif").toString())).getImage(), 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);
			...
			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "GrassTile.gif").toString())).getImage(), 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "House1Tile15.gif").toString())).getImage(), 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);
			...
			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "GrassTile.gif").toString())).getImage(), 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "House1Tile16.gif").toString())).getImage(), 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);
			...
			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "GrassTile.gif").toString())).getImage(), 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage((new ImageIcon(Paths.get(currentPath.toString(), "assets",  "TreeTopLeft3.gif").toString())).getImage(), 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);

		} else if (n3[k - n.length - n2.length] == 200) {

			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage(waterGroundMurgeGroundUp1, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift,
					64, 64, null);

		} else if (n3[k - n.length - n2.length] == 201) {

			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage(waterGroundMurgeGroundUp2, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift,
					64, 64, null);

		} else if (n3[k - n.length - n2.length] == 202) {

			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage(waterGroundMurgeGroundLeft1, 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);

		} else if (n3[k - n.length - n2.length] == 203) {

			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage(waterGroundMurgeGroundLeft2, 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);

		} else if (n3[k - n.length - n2.length] == 204) {

			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage(waterGroundMurgeGroundDown1, 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);

		} else if (n3[k - n.length - n2.length] == 205) {

			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage(waterGroundMurgeGroundDown2, 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);

		} else if (n3[k - n.length - n2.length] == 206) {

			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage(waterGroundMurgeGroundRight1, 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);

		} else if (n3[k - n.length - n2.length] == 207) {

			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage(waterGroundMurgeGroundRight2, 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);

		} else if (n3[k - n.length - n2.length] == 208) {

			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage(waterGroundMurgeGroundUpRight1, 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);

		} else if (n3[k - n.length - n2.length] == 209) {

			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage(waterGroundMurgeGroundUpRight2, 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);

		} else if (n3[k - n.length - n2.length] == 210) {

			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage(waterGroundMurgeGroundUpLeft1, 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);

		} else if (n3[k - n.length - n2.length] == 211) {

			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage(waterGroundMurgeGroundUpLeft2, 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);

		} else if (n3[k - n.length - n2.length] == 212) {

			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage(waterGroundMurgeGroundDownRight1, 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);

		} else if (n3[k - n.length - n2.length] == 213) {

			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage(waterGroundMurgeGroundDownRight2, 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);

		} else if (n3[k - n.length - n2.length] == 214) {

			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage(waterGroundMurgeGroundDownLeft1, 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);

		} else if (n3[k - n.length - n2.length] == 215) {

			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage(waterGroundMurgeGroundDownLeft2, 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);

		} else if (n3[k - n.length - n2.length] == 216) {

			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage(waterGroundMurgeWaterUpRight1, 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);

		} else if (n3[k - n.length - n2.length] == 217) {

			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage(waterGroundMurgeWaterUpRight2, 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);

		} else if (n3[k - n.length - n2.length] == 218) {

			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage(waterGroundMurgeWaterUpLeft1, 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);

		} else if (n3[k - n.length - n2.length] == 219) {

			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage(waterGroundMurgeWaterUpLeft2, 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);

		} else if (n3[k - n.length - n2.length] == 220) {

			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage(waterGroundMurgeWaterDownRight1, 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);

		} else if (n3[k - n.length - n2.length] == 221) {

			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage(waterGroundMurgeWaterDownRight2, 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);

		} else if (n3[k - n.length - n2.length] == 222) {

			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage(waterGroundMurgeWaterDownLeft1, 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);

		} else if (n3[k - n.length - n2.length] == 223) {

			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage(waterGroundMurgeWaterDownLeft2, 64 * (j - 1) - 120 + XShift,
					64 * (i - 1) - 120 + YShift, 64, 64, null);

		} else if (n3[k - n.length - n2.length] == 300) {

			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage(hillTileFront, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64,
					null);

		} else if (n3[k - n.length - n2.length] == 301) {

			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage(hillTileLeft, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64,
					null);

		} else if (n3[k - n.length - n2.length] == 302) {

			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage(hillTileTop, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64,
					null);

		} else if (n3[k - n.length - n2.length] == 303) {

			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage(hillTileRight, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64,
					null);

		} else if (n3[k - n.length - n2.length] == 304) {

			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage(hillTileHillUpLeft, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64,
					64, null);

		} else if (n3[k - n.length - n2.length] == 305) {

			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage(hillTileHillUpRight, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64,
					64, null);

		} else if (n3[k - n.length - n2.length] == 306) {

			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage(hillTileHillDownLeft, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64,
					64, null);

		} else if (n3[k - n.length - n2.length] == 307) {

			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage(hillTileHillDownRight, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64,
					64, null);

		} else if (n3[k - n.length - n2.length] == 308) {

			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage(hillTileGroundUpLeft, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64,
					64, null);

		} else if (n3[k - n.length - n2.length] == 309) {

			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage(hillTileGroundUpRight, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64,
					64, null);

		} else if (n3[k - n.length - n2.length] == 310) {

			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage(hillTileGroundDownLeft, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift,
					64, 64, null);

		} else if (n3[k - n.length - n2.length] == 311) {

			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage(hillTileGroundDownRight, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift,
					64, 64, null);

		} else if (n3[k - n.length - n2.length] == 312) {

			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage(lightSandCorner4, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 88 + YShift, 32, 32,
					null);
			g.drawImage(lightSandCorner3, 64 * (j - 1) - 88 + XShift, 64 * (i - 1) - 88 + YShift, 32, 32,
					null);
			g.drawImage(hillTileFront, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64,
					null);
			...
			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage(lightSandCorner2, 64 * (j - 1) - 88 + XShift, 64 * (i - 1) - 120 + YShift, 32, 32,
					null);
			g.drawImage(lightSandCorner4, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 88 + YShift, 32, 32,
					null);
			g.drawImage(lightSandCorner3, 64 * (j - 1) - 88 + XShift, 64 * (i - 1) - 88 + YShift, 32, 32,
			...
			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift + 64, 64 * (i - 1) - 120 + YShift, 64, 64,
					null);
			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift + 128, 64 * (i - 1) - 120 + YShift, 64, 64,
					null);
			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift + 192, 64 * (i - 1) - 120 + YShift, 64, 64,
					null);
			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift + 256, 64 * (i - 1) - 120 + YShift, 64, 64,
					null);
			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift + 320, 64 * (i - 1) - 120 + YShift, 64, 64,
					null);
			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift + 384, 64 * (i - 1) - 120 + YShift, 64, 64,
					null);
			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift + 468, 64 * (i - 1) - 120 + YShift, 64, 64,
					null);
			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift + 512, 64 * (i - 1) - 120 + YShift, 64, 64,
					null);

			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift + 64, 64, 64,
					null);
			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift + 512, 64 * (i - 1) - 120 + YShift + 64, 64,
					64, null);
			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift + 128, 64, 64,
					null);
			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift + 512, 64 * (i - 1) - 120 + YShift + 128, 64,
					64, null);
			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift + 192, 64, 64,
					null);
			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift + 512, 64 * (i - 1) - 120 + YShift + 192, 64,
					64, null);
			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift + 256, 64, 64,
					null);
			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift + 512, 64 * (i - 1) - 120 + YShift + 256, 64,
					64, null);
			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift + 320, 64, 64,
					null);
			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift + 512, 64 * (i - 1) - 120 + YShift + 320, 64,
					64, null);

			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift + 384, 64, 64,
					null);
			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift + 64, 64 * (i - 1) - 120 + YShift + 384, 64,
					64, null);
			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift + 128, 64 * (i - 1) - 120 + YShift + 384, 64,
					64, null);
			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift + 192, 64 * (i - 1) - 120 + YShift + 384, 64,
					64, null);
			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift + 256, 64 * (i - 1) - 120 + YShift + 384, 64,
					64, null);
			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift + 320, 64 * (i - 1) - 120 + YShift + 384, 64,
					64, null);
			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift + 384, 64 * (i - 1) - 120 + YShift + 384, 64,
					64, null);
			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift + 468, 64 * (i - 1) - 120 + YShift + 384, 64,
					64, null);
			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift + 512, 64 * (i - 1) - 120 + YShift + 384, 64,
					64, null);

			g.drawImage(shapemonCenter, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 576, 448,
					null);
			...
			g.drawImage(shapemonCenter, 64 * (j - 1) - 120 + XShift - 512, 64 * (i - 1) - 120 + YShift, 576,
					448, null);
			...
			g.drawImage(shapemonCenter, 64 * (j - 1) - 120 + XShift - 512,
					64 * (i - 1) - 120 + YShift - 384, 576, 448, null);
			...
			g.drawImage(shapemonCenter, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift - 384, 576,
					448, null);
			...
			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift + 128, 64, 64,
					null);
			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift + 192, 64 * (i - 1) - 120 + YShift + 128, 64,
					64, null);

			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift + 192, 64, 64,
					null);
			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift + 64, 64 * (i - 1) - 120 + YShift + 192, 64,
					64, null);
			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift + 128, 64 * (i - 1) - 120 + YShift + 192, 64,
					64, null);
			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift + 192, 64 * (i - 1) - 120 + YShift + 192, 64,
					64, null);
			...
			g.drawImage(house2, 64 * (j - 1) - 120 + XShift - 192, 64 * (i - 1) - 120 + YShift, 256, 256,
					null);
			...
			g.drawImage(house2, 64 * (j - 1) - 120 + XShift - 192, 64 * (i - 1) - 120 + YShift - 192, 256,
					256, null);
			...
			g.drawImage(house3, 64 * (j - 1) - 120 + XShift - 192, 64 * (i - 1) - 120 + YShift, 256, 256,
					null);
			...
			g.drawImage(house3, 64 * (j - 1) - 120 + XShift - 192, 64 * (i - 1) - 120 + YShift - 192, 256,
					256, null);
			...
			g.drawImage(house4, 64 * (j - 1) - 120 + XShift - 192, 64 * (i - 1) - 120 + YShift, 256, 256,
					null);
			...
			g.drawImage(house4, 64 * (j - 1) - 120 + XShift - 192, 64 * (i - 1) - 120 + YShift - 192, 256,
					256, null);
			...
			g.drawImage(house5, 64 * (j - 1) - 120 + XShift - 192, 64 * (i - 1) - 120 + YShift, 256, 256,
					null);
			...
			g.drawImage(house5, 64 * (j - 1) - 120 + XShift - 192, 64 * (i - 1) - 120 + YShift - 192, 256,
					256, null);
			...
			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage(breakableTree, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64,
					null);
		} else if (n3[k - n.length - n2.length] == 977) {
			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage(breakableRock, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64,
					null);
			...
			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage(tallGrass, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift - 16, 64, 80,
					null);
			...
			g.drawImage(pathCenter, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage(proffesor, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift - 16, 64, 80,
					null);
		}
	}
	...
	private void drawArray4(Graphics g, int k, int i, int j) {
		if (n4[k - n.length - n2.length - n3.length] == 0) {
			...
			g.drawImage(stairForwardLeft, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64,
					null);

		} else if (n4[k - n.length - n2.length - n3.length] == 501) {
			g.drawImage(stairForwardCenter, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64,
					64, null);

		} else if (n4[k - n.length - n2.length - n3.length] == 502) {
			g.drawImage(stairForwardRight, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64,
					null);
			...
			g.drawImage(proffesor, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift - 16, 64, 80,
					null);
		} else if (n4[k - n.length - n2.length - n3.length] == 401) {
			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage(tallGrass, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64, null);
	...
	private void drawArray5(Graphics g, int k, int i, int j) {
		if (n5[k - n.length - n2.length - n3.length - n4.length] == 0) {
			...
			g.drawImage(house4, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift - 192, 256, 256,
					null);
			...
			g.drawImage(hillTileRight, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64,
					null);
			g.drawImage(stairRightTop2, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64,
					null);
			...
			g.drawImage(hillTileRight, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64,
					null);
			g.drawImage(stairRightTop, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64,
					null);
			...
			g.drawImage(hillTileRight, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64,
					null);
			g.drawImage(stairRightCenter, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64,
					null);
			...
			g.drawImage(hillTileRight, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64,
					null);
			g.drawImage(stairRightBottom, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64,
					null);
			...
			g.drawImage(hillTileRight, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64,
					null);
			g.drawImage(stairRightBottom2, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64,
					null);
		...
		} else if (n5[k - n.length - n2.length - n3.length - n4.length] == 401) {
			g.drawImage(grassTile, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift, 64, 64, null);
			g.drawImage(tallGrass, 64 * (j - 1) - 120 + XShift, 64 * (i - 1) - 120 + YShift - 16, 64, 80,
					null);
