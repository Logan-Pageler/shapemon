...
public class Player {
	...
	public Player(Shapemon shapemon1, Shapemon shapemon2, Shapemon shapemon3, Shapemon shapemon4, Shapemon shapemon5) {
	    shapemonOne = shapemon1;
	    shapemonTwo = shapemon2;
	    shapemonThree = shapemon3;
	    shapemonFour = shapemon4;
	...
	public Player(Shapemon shapemon1, Shapemon shapemon2, Shapemon shapemon3, Shapemon shapemon4, Shapemon shapemon5, Shapemon shapemon6) {
	    shapemonOne = shapemon1;
	    shapemonTwo = shapemon2;
	    shapemonThree = shapemon3;
	    shapemonFour = shapemon4;
	...
	public int getNumOfShapemon() {
		...
		for(int i = 1; i<= 6; i++) {
			...
			if(getShapemon(i) == null) shapemons--;
